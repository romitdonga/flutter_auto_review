...
void main() async {
  ...
  await RateUsManager().init(
    config: const RateUsConfig(
      rateUsInitialize: 0, // 1 = enabled, 0 = disabled
...
class _HomePageState extends State<HomePage>
  ...
  Future<void> _simulateDownload() async {
    ...
    debugPrint(
      'Download count: $_downloadCount // should Rate us show: $shouldShow',
    );
  }
  ...
  Future<void> _onScreenTransition() async {
    ...
    debugPrint(
      'Screen transitions: $_screenTransitions // should Rate us show: $shouldShow',
    );
  }
